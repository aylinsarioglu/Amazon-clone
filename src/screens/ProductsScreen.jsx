...
const ProductsScreen = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.tagLine}> Price and other details may very based on the product aside and color 
      </Text>
          ...
          <View style={styles.productSection}>
            ...
            <View style={styles.productDetailSection}>
              ...
              <Text style={styles.cashbackText}>
               ...
               <Text style={styles.cashbackText}>
                Free Delivery by <Text style={styles.deliveryBy}> {item.deliveryBy} </Text>
               </Text>
